...
import (
	...
	"kylin-ccm/pkg/cluster/etcd/tmpl"
...
func GenerateEtcdCerts(mgr *manager.Manager) error {
	logs.MyLogger.Infoln("Generating etcd certs")
...
func SyncEtcdCertsToMaster(mgr *manager.Manager) error {
	logs.MyLogger.Infoln("Synchronizing etcd certs")
...
func GenerateEtcdService(mgr *manager.Manager) error {
	logs.MyLogger.Infoln("Creating etcd service")
...
func SetupEtcdCluster(mgr *manager.Manager) error {
	logs.MyLogger.Infoln("Starting etcd cluster")
...
func RefreshEtcdConfig(mgr *manager.Manager) error {
	logs.MyLogger.Infoln("Refreshing etcd configuration")
