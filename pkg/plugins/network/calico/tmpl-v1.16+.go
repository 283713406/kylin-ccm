          ...
          spec:
            ...
            properties:
              asNumber:
                ...
                type: integer
              logSeverityScreen:
                description: 'LogSeverityScreen is the logs severity above which logs
          ...
          spec:
            ...
            properties:
              ...
              bpfKubeProxyMinSyncPeriod:
                ...
                type: string
              bpfLogLevel:
                description: 'BPFLogLevel controls the logs level of the BPF programs
              ...
              kubeNodePortRanges:
                ...
                type: array
              logFilePath:
                description: 'LogFilePath is the full path to the Felix logs. Set to
                  none to disable file logging. [Default: /var/logs/calico/felix.logs]'
                type: string
              logPrefix:
                description: 'LogPrefix is the logs prefix that Felix uses when rendering
                  LOG rules. [Default: calico-packet]'
                type: string
              logSeverityFile:
                description: 'LogSeverityFile is the logs severity above which logs
                  are sent to the logs file. [Default: Info]'
                type: string
              logSeverityScreen:
                description: 'LogSeverityScreen is the logs severity above which logs
                  are sent to the stdout. [Default: Info]'
                type: string
              logSeveritySys:
                description: 'LogSeveritySys is the logs severity above which logs
              ...
              runningConfig:
                ...
                properties:
                  ...
                  healthChecks:
                    ...
                    type: string
                  logSeverityScreen:
                    description: 'LogSeverityScreen is the logs severity above which
